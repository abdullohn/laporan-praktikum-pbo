...
public class Kategori1841720209Abdulloh {
    ...
    public Kategori1841720209Abdulloh(String nama, String keterangan) {
        this.nama = nama;
    ...
    public Kategori1841720209Abdulloh getById(int id) {
        Kategori1841720209Abdulloh kat = new Kategori1841720209Abdulloh();
        ResultSet rs = DBHelper1841720209Abdulloh.selectQuery("SELECT * FROM kategori"
                + " WHERE idkategori = '" + id + "'");
    ...
    public ArrayList<Kategori1841720209Abdulloh> getAll() {
    ...
    public ArrayList<Kategori1841720209Abdulloh> search(String keyword) {
        ArrayList<Kategori1841720209Abdulloh> ListKategori = new ArrayList();
    ...
    public void save() {
        if (getById(idkategori).getIdkategori() == 0) {
            String SQL = "INSERT INTO kategori (nama, keterangan) VALUES("
                    ...
                    + " '" + this.keterangan + "' "
                    + " )";
            this.idkategori = DBHelper1841720209Abdulloh.insertQueryGetId(SQL);
    ...
    public ArrayList<Kategori1841720209Abdulloh> getByNamaAndKeterangan(String nama, String keterangan) {
        ArrayList<Kategori1841720209Abdulloh> ListKategori = new ArrayList();
        ResultSet rs;
        if ((nama.trim().length() > 0) && (keterangan.trim().length() > 0)) {
            ...
            rs = DBHelper1841720209Abdulloh.selectQuery("SELECT * FROM kategori Where nama = '" + nama + "'");
        } else {
            rs = DBHelper1841720209Abdulloh.selectQuery(
                    "SELECT * FROM kategori "
