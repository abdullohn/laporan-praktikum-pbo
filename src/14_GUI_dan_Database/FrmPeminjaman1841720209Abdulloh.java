...
public class FrmPeminjaman1841720209Abdulloh extends javax.swing.JFrame {

    /**
     * Creates new form FrmPeminjaman
     */
    public FrmPeminjaman1841720209Abdulloh() {
        initComponents();
        tampilDataAbdulloh();
    ...
    public void tampilDataAbdulloh() {
        String[] kolom = {"ID", "Peminjaman", "Judul Buku", "TanggalPinjam", "Tanggal Kembali"};
        ArrayList<Peminjaman1841720209Abdulloh> list = new Peminjaman1841720209Abdulloh().getAllAbdulloh();
        Object rowData[] = new Object[5];

        this.tblPeminjaman.setModel(new DefaultTableModel(new Object[][]{}, kolom));
        for (int i = 0; i < list.size(); i++) {
            rowData[0] = list.get(i).getmIdpeminjamanAbdulloh();
            rowData[1] = list.get(i).getAnggotaAbdulloh().getmNamaAbdulloh();
            rowData[2] = list.get(i).getBukuAbdulloh().getmJudulAbdulloh();
            rowData[3] = list.get(i).getmTanggalPinjamAbdulloh();
            rowData[4] = list.get(i).getmTanggalKembaliAbdulloh();
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(txtIdBuku, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {                                          
        ...
        Peminjaman1841720209Abdulloh pinjam = new Peminjaman1841720209Abdulloh().getByIdAbdulloh(Integer.parseInt(this.txtId.getText()));
        pinjam.setAnggotaAbdulloh(new Anggota1841720209Abdulloh().getByIdAbdulloh(Integer.parseInt(this.txtIdAnggota.getText())));
        pinjam.setBukuAbdulloh(new Buku1841720209Abdulloh().getByIdAbdulloh(Integer.parseInt(this.txtIdBuku.getText())));
        pinjam.setmTanggalPinjamAbdulloh(this.txtTanggalPinjam.getText());
        pinjam.setmTanggalKembaliAbdulloh(this.txtTanggalKembali.getText());
        pinjam.saveAbdulloh();
        tampilDataAbdulloh();
    }                                         
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        Peminjaman1841720209Abdulloh pinjam = new Peminjaman1841720209Abdulloh().getByIdAbdulloh(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pinjam.deleteAbdulloh();
        kosongkanFormAbdulloh();
        tampilDataAbdulloh();
    }                                        
    ...
    private void btnCariAnggotaActionPerformed(java.awt.event.ActionEvent evt) {                                               
        // TODO add your handling code here:
        Peminjaman1841720209Abdulloh pinjam = new Peminjaman1841720209Abdulloh();
        pinjam.cariAnggotaAbdulloh(Integer.parseInt(this.txtIdAnggota.getText()));
        this.jLabel6.setText((pinjam.getAnggotaAbdulloh().getmNamaAbdulloh()));
    }                                              
    ...
    private void btnCariBukuActionPerformed(java.awt.event.ActionEvent evt) {                                            
        ...
        this.jLabel7.setText((pinjam.getBukuAbdulloh().getmJudulAbdulloh()));
    }                                           
    ...
    private void tblPeminjamanMouseClicked(java.awt.event.MouseEvent evt) {                                           
        ...
        int row = this.tblPeminjaman.getSelectedRow();
        Peminjaman1841720209Abdulloh pinjam = new Peminjaman1841720209Abdulloh().getByIdAbdulloh(Integer.parseInt(model.getValueAt(row, 0).toString()));
        this.txtId.setText(String.valueOf(pinjam.getmIdpeminjamanAbdulloh()));

        this.txtIdAnggota.setText(String.valueOf(pinjam.getmIdanggotaAbdulloh()));
        this.txtIdBuku.setText(String.valueOf(pinjam.getmIdbukuAbdulloh()));

        this.txtTanggalPinjam.setText(String.valueOf(pinjam.getmTanggalPinjamAbdulloh()));

        this.txtTanggalKembali.setText(String.valueOf(pinjam.getmTanggalKembaliAbdulloh()));
    }                                          
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmPeminjaman1841720209Abdulloh.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmPeminjaman1841720209Abdulloh().setVisible(true);
            }
        });
    }
